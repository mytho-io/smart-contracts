...
contract BNBVRFScript is Script {
    uint256 bnb;
    ...
    function run() public {
        ...
        // // create contract for bnb vrf testing
        // VRFConsumerContract consumer = new VRFConsumerContract(
        //     77,
        //     0xcd65a78499993598be303c914c3e37b0103ead6b1f279d1dbfa0ef080e7141a4,
        //     100000,
        //     3,
        //     1,
        //     0x9632ADE542f12114f5E5AD4d6F8e47fB993955da
        // );
        // console.log("Created contract:", address(consumer));

        // vm.stopBroadcast();

        VRFConsumerContract consumer = VRFConsumerContract(
            0x29ff9C94c9C06f6be09b36a824DD7fcDeAd584De
        );

        consumer.requestRandomWords();


        // uint256 word = consumer.randomWordsReceive(0);
...
// == Logs ==
//   Deployed consumer: 0x2E617221B9929997fC0856366F868801c578e6Fe
